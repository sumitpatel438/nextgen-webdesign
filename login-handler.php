...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 3. Create a session for the logged-in user
...
<title>Login Success | Sumit's Store</title>
...
<body>
    ...
    <div class="container">
        <div class="success-message">
            ...
            <p class="success-text">Welcome back to Sumit's Store. You have been logged in successfully.</p>
